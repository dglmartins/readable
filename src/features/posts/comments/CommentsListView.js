...
import CommentBodyRow from './components/CommentBodyRow';
import CommentFooterRow from './components/CommentFooterRow';
import SortBy from '../sortBy';
import { sortByCurried } from '../services/helpers';
...
const CommentsListView = (props) => (
  <div>
    ...
    {props.comments.length > 1 && (
      <SortBy sortOptions="sortOptionsComments" sortBy={props.sortBy}/>
    )}
