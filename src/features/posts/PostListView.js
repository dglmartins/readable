...
import PostHeaderRow from './components/PostHeaderRow';
import PostFooterRow from './components/PostFooterRow';
...
const PostListView = (props) => (
  <div>
    ...
    {props.posts.length > 1 && (
      ...
      <SortBy sortOptions="sortOptionsPosts" sortBy={props.sortBy}/>
    )}
